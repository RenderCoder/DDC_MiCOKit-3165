...
RTOS_FULL       ?=$(strip $(foreach comp,$(subst .,/,$(COMPONENTS)),$(if $(wildcard $(SOURCE_ROOT)MiCO/RTOS/$(comp)),$(comp),)))
...
APP_FULL        :=$(strip $(foreach comp,$(subst .,/,$(COMPONENTS)),$(if $(wildcard $(SOURCE_ROOT)demos/$(comp) $(SOURCE_ROOT)$(comp)),$(comp),)))
...
MiCO_SDK_INCLUDES += -I$(SOURCE_ROOT)include -I$(SOURCE_ROOT)demos/$(APP_FULL)
...
$(if $(APP),,$(error No application specified. Options are: $(notdir $(wildcard demos/*))))
